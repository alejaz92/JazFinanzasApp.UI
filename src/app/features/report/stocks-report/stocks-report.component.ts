...
@Component({
    ...
    standalone: true,
    imports: [LoadingComponent, NgIf, NgFor, NgClass, DatePipe, RouterLink, CurrencyFiatFormatPipe, CurrencyInvestmentFormatPipe, ChartComponent, InfoButtonComponent],
